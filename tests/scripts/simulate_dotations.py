...
from scripts.utils_dict import translate_dict  # type: ignore
from scripts.simulation import resultfromreforms  # type: ignore
from scripts.reformePLF_2021_dotations import plf_body_2021  # type: ignore
from scripts.reformePLF_2022_dotations import plf_body_2022  # type: ignore
...
def simulate(request_body, prefix_dsr_eligible, prefix_dsr_montant, prefix_dsr_montant_annee_suivante):
    ...
    if ACTIVATE_PLF:
        ...
        if PERIOD_PLF == 2022 :
            plf = format_reforme_openfisca(plf_body_2022)
        else:
